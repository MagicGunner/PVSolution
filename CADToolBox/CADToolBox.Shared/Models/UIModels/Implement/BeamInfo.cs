...
public partial class BeamInfo(BeamModel beamModel
...
#region 主梁模型属性
    ...
    public string? SectionType {
        ...
        set =>
            SetProperty(BeamModel.SectionType,
                        value,
                        BeamModel,
                        (model,
    ...
    public string? Material {
        ...
        set =>
            SetProperty(BeamModel.Material,
                        value,
                        BeamModel,
                        (model,
    ...
    public double LeftToPre {
        ...
        set =>
            SetProperty(BeamModel.LeftToPre,
                        value,
                        BeamModel,
                        (model,
    ...
    public double RightToNext {
        ...
        set =>
            SetProperty(BeamModel.RightToNext,
                        value,
                        BeamModel,
                        (model,
    ...
    public double Length {
        ...
        set {
            if (SetProperty(BeamModel.Length,
                            value,
                            BeamModel,
                            (model,
                             value) => model.Length = value)) { OnLengthChanged(); }
        }
    }
