...
using Prism.Mvvm;
using SapToolBox.Base.DesignResources;
using SapToolBox.Base.Sections;

namespace SapToolBox.Base.DesignCodes.Implement;
...
#region 和外力无关的相关属性
    ...
    public double Phi => DesignLookup.Instance.GetChineseColdFormedPhi(LambdaModified);

    public double PhiX => DesignLookup.Instance.GetChineseColdFormedPhi(LambdaXModified);

    public double PhiY => DesignLookup.Instance.GetChineseColdFormedPhi(LambdaYModified);
